...
public class DeporteMenuActivity extends ListActivity {
    ...
    String id;
    ControlBD helper;
    String[] menu={"Insertar Deporte","Eliminar Deporte","Consultar Deporte", "Actualizar Deporte"};
    String[] activities={"DeporteInsertarActivity","DeporteEliminarActivity","DeporteConsultarActivity", "DeporteActualizarActivity"};
