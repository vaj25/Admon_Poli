...
public class TarifaSwInsertarActivity extends Activity {
    ...
    public void insertarTarifaBase(View v) {
        ...
        url=conn.getURLLocal()+"/ws_tarifa_insert.php" + "?idtarifa=" + idtarifa + "&precio=" + precio + "&canthora=" + canthora + "&cantpersona=" +  cantpersona + "&fecha_modificado=" + "CURRENT_TIMESTAMP";
